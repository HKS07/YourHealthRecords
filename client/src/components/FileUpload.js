    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `36fe5ab949811e26c763`,
            pinata_secret_api_key: `c2793eb1ecce958f3cc1677493ad1702ed10c1a7ccb8bb2975744f731549a7ec`,
    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `e709cc689776dd0e783c`,
            pinata_secret_api_key: `dd9015b2300055a6298688750b7aceeeceaafeb2f8060e878d97b54574b6a1c3`,
            "Content-Type": "multipart/form-data",
          },
        });
